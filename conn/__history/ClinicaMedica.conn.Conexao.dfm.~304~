object dm: Tdm
  ...
  object tbFunc: TFDTable
    ...
    object tbFuncdatacadastro: TDateField
  ...
  object tbUser: TFDTable
    ...
    object tbUserdatacadastro: TDateField
      FieldName = 'datacadastro'
      Origin = 'datacadastro'
    end
  end
  ...
  object tbCons: TFDTable
    ...
    object tbConsdatacadastro: TDateField
      FieldName = 'datacadastro'
      Origin = 'datacadastro'
    end
  end
  ...
  object tbPront: TFDTable
    ...
    object tbProntid_pront_paci: TIntegerField
      FieldName = 'id_pront_paci'
      Origin = 'id_pront_paci'
    end
  ...
  object frxPDFExport1: TfrxPDFExport
    ...
    ShowProgress = True
    OverwritePrompt = False
    CreationTime = 45042.488435798610000000
    DataOnly = False
  ...
  object relPacientes: TfrxReport
    ...
    ReportOptions.LastChange = 45035.455068148100000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
  ...
  object relProntuarios: TfrxReport
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 45036.471377974500000000
    ReportOptions.LastChange = 45036.490282650500000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Relat'#243'rio de prontu'#225'rio')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      object GroupHeader1: TfrxGroupHeader
        ...
        Top = 264.567100000000000000
        Width = 718.110700000000000000
        Condition = 'DSProntuarios."dataconsulta"'
      end
      object MasterData1: TfrxMasterData
        FillType = ftBrush
        FillGap.Top = 0
        ...
        object Memo4: TfrxMemoView
          AllowVectorExport = True
          Left = 158.897650000000000000
          Width = 2212.000000000000000000
          Height = 18.897650000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[DSProntuarios."queixa_principal"]')
          ParentFont = False
          Style = 'Data'
        end
        object Memo5: TfrxMemoView
        ...
        object Memo6: TfrxMemoView
          ...
          Height = 18.897650000000000000
          DataField = 'hipotese_diagnostica'
          DataSet = relDsPront
          DataSetName = 'DSProntuarios'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[DSProntuarios."hipotese_diagnostica"]')
          ParentFont = False
          Style = 'Data'
        end
        object Memo7: TfrxMemoView
        ...
        object Memo10: TfrxMemoView
          ...
          Left = 158.897650000000000000
          Top = 56.692950000000000000
          Width = 2580.000000000000000000
          Height = 18.897650000000000000
          DataField = 'historico_sintoma'
          DataSet = relDsPront
          DataSetName = 'DSProntuarios'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[DSProntuarios."historico_sintoma"]')
          ParentFont = False
          Style = 'Data'
        end
        object Memo11: TfrxMemoView
        ...
        object Memo18: TfrxMemoView
          ...
          Width = 78.000000000000000000
          Height = 18.897650000000000000
          DataField = 'data_ultima_consulta'
          DataSet = relDsPront
          DataSetName = 'DSProntuarios'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[DSProntuarios."data_ultima_consulta"]')
          ParentFont = False
          Style = 'Data'
        end
        object Memo19: TfrxMemoView
        ...
        object Memo22: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[DSProntuarios."horariofimconsulta"]')
          ParentFont = False
          Style = 'Data'
        end
        object Memo2: TfrxMemoView
  ...
  object relDsPront: TfrxDBDataset
    UserName = 'DSProntuarios'
    CloseDataSource = False
    DataSet = qryRelPront
    BCDToCurrency = False
    DataSetOptions = []
  ...
  object tbFinanceiro: TFDTable
    ...
    object tbFinanceirodatamov: TDateField
      FieldName = 'datamov'
      Origin = 'datamov'
    end
  end
  ...
  object relFinanceiro: TfrxReport
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 45042.408663298600000000
    ReportOptions.LastChange = 45042.408663298600000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
    ...
    Datasets = <
      item
        DataSet = relDsFinanceiro
        DataSetName = 'DSFinanceiro'
      end>
    Variables = <>
    Style = <
      item
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Top = 264.567100000000000000
        Width = 740.409927000000000000
        Condition = 'DSFinanceiro."datamov"'
        object Memo2: TfrxMemoView
          Align = baWidth
          AllowVectorExport = True
          Width = 740.409927000000000000
  ...
  object relDsFinanceiro: TfrxDBDataset
    UserName = 'DSFinanceiro'
    CloseDataSource = False
    DataSet = qryRelFinan
    BCDToCurrency = False
    DataSetOptions = []
  ...
  object relPrescricao: TfrxReport
    Version = '2023.1.3'
    DataSet = relDsAtestado
    DataSetName = 'atestado'
    DotMatrixReport = False
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 45047.864629988400000000
    ReportOptions.LastChange = 45047.868865891210000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
  ...
  object qryRelExames: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select u.nome_user, e.* , conv.nome_conv, p.nome_paci, prontexam' +
        '.desc_pront from exames as e inner join usuarios as u ON u.id_fu' +
        'nc_user = e.id_med '
      
        'inner join convenios as conv on e.id_conv = conv.id_conv inner j' +
        'oin pacientes as p on e.id_paci = p.id_paci '
  ...
  object relExames: TfrxReport
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 45049.453002395800000000
    ReportOptions.LastChange = 45049.458320775460000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo21: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Valor total de consultas na p'#225'g : R$ [SUM(<DSExames."valor_exam"' +
              '>,MasterData1)],00')
          ParentFont = False
        end
      end
  ...
  object qryVerificaStatusFunc: TFDQuery
    Connection = Connection
    Left = 560
    Top = 9
  end
