object dm: Tdm
  ...
  object PgDriverLink: TFDPhysPgDriverLink
    VendorLib = 'C:\Users\User\Desktop\Clinica M'#233'dica\Win32\Debug\lib\libpq.dll'
    Left = 96
    Top = 8
  end
  ...
  object qryFunc: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select funcionarios.*, cargos.* from funcionarios inner join car' +
        'gos on funcionarios.cargo_func = cargos.id_carg ')
    Left = 248
    Top = 176
  end
